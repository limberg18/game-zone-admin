...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SportCancha — Administración de Canchas Deportivas" },
      { name: "description", content: "Sistema integral para administrar canchas deportivas, reservas, torneos y productos." },
    ],
    links: [
